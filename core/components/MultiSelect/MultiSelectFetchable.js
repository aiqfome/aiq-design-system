...
exports.MultiSelectFetchable = void 0;
...
const SelectedItem = styled_components_1.default(Text_1.Text) `
  white-space: nowrap;
`;
exports.MultiSelectFetchable = (_a) => {
    var { items, maxWidth, filters = [], onChange, value = [], isLoading = false, placeholder, loadingMessage = 'carregando...', emptyMessage = 'item não encontrado ou já adicionado', errorForm, errorMessage, isDependent = false, dependentMessage = 'este campo tem alguma dependência', handleSelectedItemChange = () => {
        // do nothing.
    } } = _a, props = __rest(_a, ["items", "maxWidth", "filters", "onChange", "value", "isLoading", "placeholder", "loadingMessage", "emptyMessage", "errorForm", "errorMessage", "isDependent", "dependentMessage", "handleSelectedItemChange"]);
    ...
    return (react_1.default.createElement(Flex_1.Flex, { flexDirection: 'column', flex: 1 },
        react_1.default.createElement(MultiSelectStyled, Object.assign({ position: 'relative', maxWidth: maxWidth, "data-testid": 'multiselect-fechable', onClick: () => inputRef.current.focus() }, props),
            react_1.default.createElement(ContainerInput, { backgroundColor: 'white', borderRadius: 4, display: 'flex', flexDirection: 'row', errorForm: errorForm, refBox: el => {
                ...
                react_1.default.createElement(Flex_1.Flex, { maxWidth: '90%', overflow: 'hidden', ref: el => setRefBadges(el || null) },
                    selectedItems.slice(0, itemLimit).map((selectedItem, index) => (react_1.default.createElement(Flex_1.Flex, { py: 2, minWidth: selectedItems.length === 1 ? 0 : undefined, key: `selected-item-${index}`, px: 4, mr: 3, display: 'flex', flexDirection: 'row', alignItems: 'center', backgroundColor: 'primary', borderRadius: '3px' },
                ...
                react_1.default.createElement("input", Object.assign({ type: 'text', placeholder: placeholder, style: { width: '100%', flex: 1, paddingLeft: '5px' } }, getInputProps(getDropdownProps({
                    ref: inputRef,
                ...
                isLoading && react_1.default.createElement(Loading_1.Loading, { size: 'small' })),
            react_1.default.createElement(Overflow, { isOpen: isOpen, mt: 13, py: 7, flexDirection: 'column', backgroundColor: 'white', border: '1px solid #dedede' },
                !isDependent && (react_1.default.createElement(react_1.default.Fragment, null,
                    react_1.default.createElement("ul", null, filters.map((filter, index) => (react_1.default.createElement("li", { key: `filter-${index}`, onClick: () => filterItems(filter) },
                ...
                react_1.default.createElement(Itens, null,
                    react_1.default.createElement("ul", Object.assign({}, getMenuProps()),
                        isOpen &&
                            !isDependent &&
                            !isLoading &&
                            getFilteredItems().map((item, index) => (react_1.default.createElement("li", { className: highlightedIndex === index ? 'highlighted' : '', key: `${item}${index}`, onClick: e => {
                                    getItemProps({ item, index }).onClick(e);
                                    setItemLimit(undefined);
                                } }, item.name))),
                        isDependent && react_1.default.createElement("li", null, dependentMessage),
                        isOpen && isLoading && !isDependent && react_1.default.createElement("li", null, loadingMessage),
                        isOpen &&
                            !isLoading &&
                            !isDependent &&
                            getFilteredItems().length === 0 && react_1.default.createElement("li", null, emptyMessage))))),
        errorForm && react_1.default.createElement(InputErrorMessage_1.InputErrorMessage, { errorMessage: errorMessage })));
};
exports.MultiSelectFetchable.propTypes = {
